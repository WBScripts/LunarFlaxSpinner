 ...
 * @author Wastedbro
 */
@ScriptManifest(name = "Lunar Flax Spinner", authors = "Wastedbro", category = "Magic", version = 1.0,
        description = "Spins Flax using the Lunar Spell. Logs out when done")
public class LunarFlaxSpinner extends Script implements Painting
{
    ...
    public void run()
    {
        ...
        while(runScript)
        {
            // Modifies the reaction parameters based on RS Username
